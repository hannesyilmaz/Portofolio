...
Step_5
- Run MLModelMLCReturns_4.py to run our fetched articles that originated from RSS feeds. Each article will receive its multi-label classification (topics of the news) and be returned as a dictionary to be read and deposited into our database. 
Step_6
- Run DbTransfer_5.py to deposit all the labeled articles with the necessary additional data (such as date, link, etc.).
